...
(function () {
  ...
  function colorFor(hue, alpha) {
    if (hue === 0) return "rgba(52, 245, 164, " + alpha + ")";
    if (hue === 1) return "rgba(56, 189, 248, " + alpha + ")";
  ...
  function draw() {
    ...
    if (pointer.active && !reduceMotion) {
      ...
      ctx.strokeStyle = "rgba(52, 245, 164, 0.15)";
      ctx.lineWidth = 1;
      ctx.beginPath();
